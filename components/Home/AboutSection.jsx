            ...
            <div className="grid grid-cols-2 gap-2">
              {features.map((feature, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`group p-2 rounded-2xl bg-white/60 backdrop-blur-sm border border-white/50 hover:bg-white/80 transition-all duration-500 cursor-pointer transform hover:scale-105 hover:-translate-y-1 ${
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <div
                        className={`min-w-[40px] w-10 h-10 bg-gradient-to-r ${feature.color} rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                      >
                    ...
                    {/* Hover Effect */}
                    <div
                      className={`mt-2 h-1 bg-gradient-to-r ${
                        feature.color
