...
const CoursesSection = () => {
      ...
      >
        ...
        <div className="relative  h-full flex flex-col">
          ...
          `}
            ...
            <p
              className={`
            text-sm leading-relaxed mb-8 flex-grow transition-all duration-300
            ${course.textColor} ${
          ...
          `}
            ...
            {/* Learn More Button */}
            <button
              onClick={() => router.push("/courses/courseVideos/2")}
              className={`
  ...
  return (
    <div className=" bg-gradient-to-br from-slate-50 via-blue-50 to-teal-50 py-16 px-4">
