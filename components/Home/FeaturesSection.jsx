...
export default function FeaturesSection() {
  ...
  const features = [
    {
      ...
      description:
        "We tailor our courses to match your unique needs and learning goals. With flexible schedules and individualized attention, your success is our priority",
    ...
    },
    {
      ...
      description:
        "Our team is here to guide and support you every step of the way. From course selection to mastering Arabic, we ensure a seamless journey",
  ...
  return (
    <div className=" bg-gradient-to-br from-slate-50 via-white to-gray-100 py-20 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-teal-100 to-cyan-100 rounded-full px-6 py-3 mb-8 animate-fade-in">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto animate-fade-in-delay">
            Discover our innovative approach to Arabic language education with
            cutting-edge methods and personalized support
          </p>
        </div>
