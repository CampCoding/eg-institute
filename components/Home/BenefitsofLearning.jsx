...
const ArabicBenefitsSection = () => {
  ...
  const benefits = [
    {
      ...
      description:
        "Experience the richness of Arabic culture through interactive activities and practical class",
    ...
    },
    {
      ...
      description:
        "Choose from group classes, one-on-one sessions, or self-paced courses to match your schedule and goals",
    ...
    },
    {
      ...
      description:
        "Join thousands of successful learners who have achieved fluency and confidence through our programs.",
    ...
    },
    {
      ...
      description:
        "Our lessons are customized to your specific needs, whether you're learning for travel, work, or personal growth.",
  ...
  return (
    <div className=" bg-gradient-to-br from-slate-50 via-gray-50 to-blue-50 py-20 px-4 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10" ref={sectionRef}>
        ...
        >
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-teal-500 to-blue-600 text-white px-6 py-2 rounded-full text-sm font-semibold mb-6 shadow-lg animate-bounce-subtle">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-800 mb-6 leading-tight">
            ...
            <span className="bg-gradient-to-r from-teal-500 to-blue-600 bg-clip-text text-transparent animate-gradient-text">
              Egyptian Institute
            </span>
            <br />
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-10">
          {benefits.map((benefit, index) => (
            ...
            >
              {/* Card Container */}
              <div
                className={`relative h-full bg-gradient-to-br ${benefit.bgGradient} border border-white/30 rounded-3xl p-8 shadow-xl hover:shadow-2xl ${benefit.glowColor} transition-all duration-500 overflow-hidden`}
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div
                      className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${benefit.gradient} flex items-center justify-center shadow-lg transform transition-all duration-300 group-hover:scale-110 group-hover:rotate-6`}
                    >
                    ...
                    {/* Accent Icon */}
                    <div
                      className={`w-10 h-10 rounded-full bg-white/20 flex items-center justify-center opacity-0 group-hover:opacity-100 transform translate-x-4 group-hover:translate-x-0 transition-all duration-500`}
                    >
                  ...
                  <div className="mt-6 flex items-center justify-between">
                    ...
                    <div
                      className={`opacity-0 group-hover:opacity-100 transform translate-x-4 group-hover:translate-x-0 transition-all duration-500 delay-100`}
                    >
              ...
              {/* Glow Effect */}
              <div
                className={`absolute inset-0 bg-gradient-to-br ${benefit.gradient} rounded-3xl blur-xl opacity-0 group-hover:opacity-20 transition-opacity duration-500 -z-10`}
              ></div>
            </div>
          ))}
        </div>
        ...
        >
          <div className="inline-flex items-center space-x-4 bg-gradient-to-r from-slate-800 to-slate-900 text-white px-8 py-4 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 cursor-pointer group">
            <div className="flex space-x-1">
              {[...Array(3)].map((_, i) => (
                <div
                  key={i}
        ...
        {/* <img
          className="mt-[30px]"
          src="/images/onlin-learning-arabic.png"
          alt=""
        /> */}
      </div>
