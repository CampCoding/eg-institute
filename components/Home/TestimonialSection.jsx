...
const ACCENT_PALETTE = [
  { accent: "from-rose-400 to-pink-500", bgAccent: "from-rose-50 to-pink-50" },
  { accent: "from-blue-400 to-indigo-500", bgAccent: "from-blue-50 to-indigo-50" },
  { accent: "from-emerald-400 to-teal-500", bgAccent: "from-emerald-50 to-teal-50" },
  { accent: "from-purple-400 to-violet-500", bgAccent: "from-purple-50 to-violet-50" },
  { accent: "from-amber-400 to-orange-500", bgAccent: "from-amber-50 to-orange-50" },
  { accent: "from-cyan-400 to-blue-500", bgAccent: "from-cyan-50 to-blue-50" },
];
...
const TestimonialSection = () => {
  ...
  const section = home_data?.message?.sections?.testimonials;
  const rawTestimonials = home_data?.message?.testimonials;

  const testimonials = rawTestimonials?.length
    ? rawTestimonials.map((t, i) => ({
        id: t.id,
        name: t.student_name,
        role: "",
        company: t.course_name,
        image: t.student_image,
        rating: parseFloat(t.rating) || 5,
        text: t.review,
        location: t.location,
        courseCompleted: t.course_name,
        testimonialDate: t.review_date,
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            {section?.subtitle ?? "Discover the transformative experiences of our Arabic language learners"}
          </p>
        </div>
