...
import { apiRoutes } from "../../libs/shared/routes";
...
const ContactSection = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await _post(apiRoutes.send_contact_message, {
        name,
        email,
        message,
      });
          ...
          <div className="space-y-12">
            ...
            >
              ...
              <div className="space-y-2 text-gray-600 text-lg">
                ...
                <p>
                  Contact us today and let's make learning Arabic effortless!
                </p>
              </div>
            </div>
            ...
            <div className="space-y-8">
              {/* Email Support */}
              <div
                className={`group flex items-start space-x-6 p-6 bg-white/60 backdrop-blur-sm rounded-3xl border border-white/40 shadow-lg hover:shadow-xl transform transition-all duration-500 ${
                  isVisible
                    ? "translate-y-0 opacity-100"
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-1 text-gray-600">
                    <p className="hover:text-teal-600 transition-colors duration-300 cursor-pointer">
              ...
              >
                <div className="w-16 h-16 bg-gradient-to-br from-teal-400 to-cyan-500 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                  ...
                  >
                    <path d="M20.52 3.48A11.94 11.94 0 0012 0C5.37 0 0 5.37 0 12a11.94 11.94 0 001.69 6.09L0 24l6.17-1.62A11.94 11.94 0 0012 24c6.63 0 12-5.37 12-12 0-3.2-1.25-6.21-3.48-8.52zM12 22a9.94 9.94 0 01-5.09-1.4l-.36-.21-3.65.96.97-3.56-.24-.37A9.94 9.94 0 012 12C2 6.48 6.48 2 12 2c2.66 0 5.17 1.04 7.07 2.93A9.94 9.94 0 0122 12c0 5.52-4.48 10-10 10zm5.05-7.16c-.28-.14-1.65-.81-1.9-.9-.25-.1-.43-.14-.6.14-.17.28-.69.9-.85 1.08-.16.17-.31.19-.59.05-.28-.14-1.17-.43-2.22-1.36-.82-.73-1.37-1.62-1.53-1.9-.16-.28-.02-.43.12-.57.12-.12.28-.31.42-.47.14-.16.19-.28.28-.47.09-.19.05-.36-.02-.5-.07-.14-.6-1.44-.82-1.97-.22-.53-.44-.46-.6-.47h-.51c-.17 0-.45.06-.68.31-.23.25-.9.88-.9 2.15s.92 2.49 1.05 2.66c.14.17 1.81 2.76 4.38 3.87.61.26 1.08.41 1.45.53.61.19 1.16.16 1.6.1.49-.07 1.65-.67 1.88-1.31.23-.64.23-1.18.16-1.31-.07-.14-.26-.22-.54-.36z" />
                  </svg>
                </div>
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-gray-800 mb-2 group-hover:text-teal-600 transition-colors duration-300">
                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-1 text-gray-600">
                    <p>
                      ...
                      <span className="hover:text-green-600 transition-colors duration-300 cursor-pointer">
                        +201285393258
                      </span>
                    </p>
                    <p>
