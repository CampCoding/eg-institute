...
const Header = () => {
  ...
  const navigations = [
    ...
    { name: "About us", path: "/about-us" , hidden : false },
    { name: "Contact us", path: "/contact-us" , hidden : false },
    { name: "Blog", path: "/blogs" ,hidden : false},
    { name: "Teachers", path: "/teachers" ,hidden : false},
    { name: "Store", path: "/store",hidden : false },
    { name: "Courses", path: "/courses",hidden : false },
    { name: "Exams", path: "/exams",hidden : false },
    ...
    <div className="relative">
      ...
      {showDropdown && (
        <div className="absolute right-0 top-full mt-2 w-52 bg-white rounded-xl shadow-xl border border-gray-200 py-2 z-50">
          {isLoggedIn ? (
            <>
              <Link href="/profile/2" className="flex items-center space-x-3 px-4 py-2 hover:bg-gray-50 transition-colors">
