...
export default function AnimatedFooter() {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-amber-100 via-yellow-50 to-orange-100 ">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
        ...
        >
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="group cursor-pointer">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-teal-400 to-blue-500 rounded-2xl blur-xl opacity-20 group-hover:opacity-40 transition-opacity duration-500"></div>
                <div className="relative rounded-2xl p-4  group-hover:shadow-2xl transition-all duration-500 group-hover:scale-105">
          ...
          >
            <h3 className="text-2xl font-bold text-teal-600 mb-6 relative">
              Support
            ...
            <ul className="space-y-3">
              {supportLinks.map((link, index) => (
                <li key={index}>
                  <a
                    href="#"
                    className="group flex items-center text-gray-600 hover:text-teal-600 transition-all duration-300"
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-600 text-center md:text-left">
              Copyright© 2023 CourseOn, All rights reserved. Powered by{" "}
              <span className="font-semibold text-teal-600 hover:text-teal-800 transition-colors duration-300 cursor-pointer">
                Camp Coding
              </span>
            </p>
