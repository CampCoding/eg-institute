  ...
  const menuItems = [
    ...
    },
    {
    ...
    },
     {
      id: "Teachers",
      label: "Teachers",
      icon: User, // Changed from Video to GraduationCap (better for learning/courses)
    ...
    },
     {
      id: "Store",
      label: "Store",
      icon: Store, // Changed from Video to GraduationCap (better for learning/courses)
      color: "from-pink-500 to-rose-500",
      path:"/store",
    },
    {
      ...
      id: "Exams",
      label: "Exams",
      icon: BookOpenCheck, // Changed from Video to GraduationCap (better for learning/courses)
      color: "from-pink-500 to-rose-500",
      path:"/exams",
    },
  ];
