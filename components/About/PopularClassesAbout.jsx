        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            >
              ...
              <img
                src="https://egyptianinstitute.com/wp-content/uploads/2025/01/img_4.png"
                alt=""
              />
            ...
            {/* Bottom Colored Bars */}
            <div
              className={`flex mt-8 space-x-4 transform transition-all duration-1200 delay-300 ${
                isVisible
            ...
            >
              ...
              <div
                className="h-4 bg-gradient-to-r from-teal-400 to-cyan-400 rounded-full flex-1 animate-pulse"
                style={{ animationDelay: "0.2s" }}
              ></div>
              <div
                className="h-4 bg-gradient-to-r from-blue-400 to-indigo-400 rounded-full flex-1 animate-pulse"
          ...
          <div className="space-y-8">
            ...
            >
              We offer a unique learning experience that combines modern
              techniques with cultural immersion, making Arabic learning easy
              and enjoyable.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {learningFeatures.map((feature, index) => (
                <div
                  key={index}
                  className={`group flex items-center space-x-4 p-4 rounded-2xl bg-white/60 backdrop-blur-sm border border-white/40 shadow-lg hover:shadow-xl transform transition-all duration-500 cursor-pointer ${
                    isVisible
                      ? "translate-y-0 opacity-100"
                      : "translate-y-8 opacity-0"
                  }`}
