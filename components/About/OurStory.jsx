...
// Milestones static (مفيش API ليها)
const STATIC_MILESTONES = [
  {
    ...
    fullTitle: "Founded with Vision",
    fullDesc: "Started our journey to revolutionize Arabic education",
  },
  {
    icon: Users,
    year: "2021",
    ...
    fullTitle: "Community Growth",
    fullDesc: "Reached 10,000+ students across the globe",
  },
  {
    icon: Globe,
    year: "2024",
    ...
    fullTitle: "Global Impact",
    fullDesc: "Expanded to 50+ countries with innovative methods",
  },
];
...
export default function OurStory({ story }) {
  ...
  const paragraphs = story?.story_description?.split("\n\n") || [];
    ...
    <div ref={sectionRef} className="relative min-h-screen overflow-hidden">
      ...
      <div className="hidden lg:grid absolute inset-0 lg:grid-cols-2">
        ...
        <div
          className="relative"
          style={{
            backgroundImage: storyImage ? `url('${storyImage}')` : undefined,
            backgroundSize: "cover",
            backgroundPosition: "center",
          }}
        >
      ...
      <div className="relative z-10 min-h-screen flex items-center py-12 md:py-16 lg:py-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            {/* Left Content */}
            <div
              className={`text-white transition-all duration-700 md:duration-1000 ${isVisible
            ...
            {/* Right Side - Milestones (Static) */}
            <div
              className={`transition-all duration-700 md:duration-1000 delay-200 md:delay-300 ${isVisible
                ? "opacity-100 translate-x-0"
                : "opacity-0 translate-x-4 md:translate-x-8"
                }`}
            >
              ...
              <div className="lg:hidden grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {STATIC_MILESTONES.map((milestone, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className={`bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 transition-all duration-500 ${isVisible
              ...
              <div className="hidden lg:block space-y-8">
                {STATIC_MILESTONES.map((milestone, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className={`flex items-start space-x-6 transition-all duration-700 ${isVisible
                        ? "opacity-100 translate-x-0"
