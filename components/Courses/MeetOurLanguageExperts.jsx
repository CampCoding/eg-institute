  ...
  return (
    <div className="relative  overflow-hidden">
      ...
      <div
        style={{
          backgroundImage:
            "url('/images/young-student-wearing-headphones-studies-online-distance-learning-.jpg')",
                  ...
                  <div className="relative rounded-lg overflow-hidden">
                    ...
                    `}
                      ...
                      >
                        ...
                        <br />
                        <span className="bg-gradient-to-r text-5xl from-teal-300 to-blue-300 bg-clip-text text-transparent">
                          Learn from experienced instructors passionate about
                          helping you succeed
                        </span>
                      </h1>
                      ...
                      <button
                        className={`
                      px-8 py-3 mt-6 bg-teal-500 hover:bg-teal-400 text-white font-semibold rounded-lg
...
export default MeetOurLanguageExperts;
