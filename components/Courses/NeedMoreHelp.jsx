...
export default function NeedMoreHelp() {
  ...
  const features = [
    ...
    },
    {
        ...
        <>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <path
              ...
              strokeLinejoin="round"
              strokeWidth={2}
              d="M9 10a.5.5 0 0 0 1 0V9a.5.5 0 0 0-1 0v1zm0 0a5 5 0 0 0 5 5m0 0h1a.5.5 0 0 0 0-1h-1m0 1v1a.5.5 0 0 0 1 0v-1"
            ></path>
          </svg>
        </>
      ),
      ...
      description:
        "Get instant assistance and answers to your questions through our dedicated WhatsApp support. Our team is ready to help you with course inquiries, technical support",
      color: "from-emerald-500 to-teal-500",
      bgColor: "from-emerald-50 to-teal-50",
      iconBg: "from-emerald-100 to-teal-100",
      delay: 400,
