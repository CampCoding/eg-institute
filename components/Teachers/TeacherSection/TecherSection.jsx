      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="mb-16 md:mb-20 text-center">
          <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-teal-500/10 via-cyan-500/10 to-teal-500/10 backdrop-blur-sm rounded-full px-8 py-4 mb-8 border border-teal-200/50 shadow-sm">
            ...
            <span className="text-teal-700 font-semibold text-lg">Meet Our Expert Teachers</span>
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Our experienced educators combine deep linguistic knowledge with innovative teaching methods 
            to accelerate your Arabic learning journey.
          </p>
        </div>
          ...
          {teachers.map((teacher, index) => (
            ...
            >
              ...
              <div className="relative h-full rounded-3xl bg-white/80 backdrop-blur-sm border border-gray-200/50 shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden group-hover:-translate-y-2">
                <div className={`absolute inset-0 bg-gradient-to-br from-teal-500/5 to-cyan-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10`}></div>
                ...
                <div className="relative aspect-[4/3] overflow-hidden rounded-t-3xl">
                  ...
                  <div className={`absolute bottom-4 right-4 transition-all duration-300 ${hoveredCard === teacher.id ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                ...
                <div className="relative h-full   p-8 z-20">
                  ...
                  <div className="flex items-center justify-between mb-6 text-sm text-gray-600">
                    ...
                    <span className="text-teal-600 font-semibold">Expert Level</span>
                  </div>
